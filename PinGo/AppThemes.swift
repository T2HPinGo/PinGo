...
struct AppThemes {
    ...
    static let cellColors = [UIColor(red: 122.0/255.0, green: 80.0/255.0, blue: 118.0/255.0, alpha: 1.0),
    ...
    //--- UI Colors - Haena
    static let navigationBackgroundColor = UIColor(red: 69.0/255.0, green: 58.0/255.0, blue: 75.0/255.0, alpha: 1.0)
